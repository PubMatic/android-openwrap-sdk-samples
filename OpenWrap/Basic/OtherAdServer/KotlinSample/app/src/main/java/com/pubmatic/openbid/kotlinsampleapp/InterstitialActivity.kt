...
import com.pubmatic.openwrap.kotlinsampleapp.customhandler.CustomInterstitialEventHandler
...
class InterstitialActivity : AppCompatActivity() {
    ...
    private val OPENWRAP_AD_UNIT_ID = "OtherASInterstitialAdUnit"
    private val PUB_ID = "156276"
    private val PROFILE_ID = 1165
    private val DUMMY_AD_SERVER_AD_UNIT_ID = "OtherASInterstitialAdUnit"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val eventHandler = CustomInterstitialEventHandler(this, DUMMY_AD_SERVER_AD_UNIT_ID)
