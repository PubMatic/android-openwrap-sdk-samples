...
public class InBannerVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // For example, The code below creates an event handler for MoPub ad server with InBannerVideo adsize 300x250.
        MoPubBannerEventHandler eventHandler = new MoPubBannerEventHandler(this, MOPUB_AD_UNIT_ID, POBAdSize.BANNER_SIZE_300x250);
