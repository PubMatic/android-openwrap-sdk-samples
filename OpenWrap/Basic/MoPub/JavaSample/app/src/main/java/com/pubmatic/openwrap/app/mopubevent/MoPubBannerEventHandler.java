 ...
 * unit. It implements the PubMatic's OpenWrap interface. POB SDK notifies (using OpenWrap interface)
...
public class MoPubBannerEventHandler implements POBBannerEvent, MoPubView.BannerAdListener {
    ...
    public void onBannerLoaded(MoPubView banner) {
        ...
        POBBid pubmaticBid = (POBBid) banner.getLocalExtras().get(POBBannerCustomEvent.BID_KEY);
        if (pubmaticBid != null) {
            ...
            onBannerFailed(banner, MoPubErrorCode.NETWORK_NO_FILL);
        }
    ...
    public void onBannerFailed(MoPubView banner, MoPubErrorCode errorCode) {
        ...
        if (eventListener != null) {
            ...
            PMLog.error(TAG, "Can not call failure callback, POBBannerEventListener reference null. MoPub error:"+errorCode.toString());
        }
