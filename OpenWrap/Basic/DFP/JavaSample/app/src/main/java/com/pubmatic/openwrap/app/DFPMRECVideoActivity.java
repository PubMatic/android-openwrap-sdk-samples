...
/**
 * Activity class to demonstrate, OpenBid MREC Video implementation with DFP integration.
 */
public class DFPMRECVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dfp_mrec_video);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        toolbar.setTitle(R.string.mrec_video_title);
