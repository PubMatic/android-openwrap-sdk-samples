...
/**
 * Activity to show MREC Display Implementation
 */
class MRECDisplayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.setTitle(R.string.title_activity_mrec_display)
        ...
        banner?.init(Constants.PUB_ID, Constants.PROFILE_ID, OPENWRAP_AD_UNIT_ID, POBAdSize.BANNER_SIZE_300x250)
