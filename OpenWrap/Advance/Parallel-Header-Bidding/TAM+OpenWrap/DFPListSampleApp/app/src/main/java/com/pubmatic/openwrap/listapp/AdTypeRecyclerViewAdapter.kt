 ...
 */
class AdTypeRecyclerViewAdapter(val list: ArrayList<Constants.AD_TYPE>?, val itemClickListener: OnItemClickListener) :  RecyclerView.Adapter<AdTypeRecyclerViewAdapter.AdViewHolder>(){
