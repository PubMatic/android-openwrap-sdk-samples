...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Important Note: Initialize MoPub SDK before making any calls to MoPub.
        SdkConfiguration.Builder sdkConfiguration = new SdkConfiguration.Builder("AD_UNIT_ID");
    ...
    public void loadAdScreen(String adType) {
        ...
        if (adType.equals("Banner Ad")) {
            intent = new Intent(MainActivity.this, MoPubBannerActivity.class);
        } else {
            intent = new Intent(MainActivity.this, MoPubInterstitialActivity.class);
        }
