 ...
 */
public class MoPubBannerActivity extends AppCompatActivity implements POBBidEventListener, BiddingManagerListener {
    ...
    // MoPub Ad unit id
    private static final String MOPUB_AD_UNIT_ID = "70b00f8c1ffb467ab9147e14812a1428";

    // A9 TAM slot id
    private static final String SLOT_ID = "5ab6a4ae-4aa5-43f4-9da4-e30755f2b295";
    ...
    private MoPubBannerEventHandler eventHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mopub_wrapper);
        ...
        // Register partners to bidding manager
        registerBidders();
         ...
         * before MoPub ad call is initiated by the MoPubBannerEventHandler.
         */
        ...
        // Set config listener on POBBannerView to pass partner targeting to MoPub
        setConfigListener();
    }
    //endregion
    ...
    /**
     * Fetch bid from PubMatic OpenWrap partners and load MoPub ad.
     */
    private void loadOpenWrapBids(){
        ...
        eventHandler = new MoPubBannerEventHandler(this, MOPUB_AD_UNIT_ID, new POBAdSize(320, 50));
        ...
        // Set request timeout
        banner.getAdRequest().setNetworkTimeout(REQUEST_TIMEOUT);
    ...
    private void registerBidders() {
        // You can create other partners here and register to bidding manager.
        // Add A9 TAM partner as bidder
    ...
    private void setConfigListener() {
        eventHandler.setConfigListener((moPubView, pobBid) -> {
            if (partnerTargeting != null && partnerTargeting.size() > 0) {
                ...
                Log.d(TAG, "MoPub Targeting param = " + keywords.toString());
