...
/**
 * Class definition demonstrate recycler adapter to show banner feed list
 */
class BannerFeedListAdapter(private val bannerFeedItems: ArrayList<BannerFeedItem>): RecyclerView.Adapter<ViewHolder>() {

    private val TAG: String = "BannerFeedListAdapter"
    private var onBannerBindListener: OnBannerBindListener? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // Create view holder according to feed type
        return if(viewType == BannerFeedItem.FeedType.BANNER.ordinal){
    ...
    override fun getItemViewType(position: Int): Int {
        return bannerFeedItems[position].feedType.ordinal
    }

    override fun getItemCount(): Int {
        return bannerFeedItems.size
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val feedItem = bannerFeedItems[position]
        if(holder is BannerViewHolder){
            ...
            onBannerBindListener?.onBannerBind(position)
    ...
    /**
     * Setter to provide callbacks on banner's bind on the view
     */
