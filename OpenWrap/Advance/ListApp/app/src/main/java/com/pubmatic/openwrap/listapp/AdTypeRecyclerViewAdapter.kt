...
/**
 * Recyclerview adapter used for List Adapter implementation. This class shows the entry for the Ad
 * types for demonstrating the respective features.
 */
class AdTypeRecyclerViewAdapter(private val list: ArrayList<MainActivity.AD_TYPE>?, private val itemClickListener: OnItemClickListener) :  RecyclerView.Adapter<AdTypeRecyclerViewAdapter.AdViewHolder>(){
    ...
    override fun onBindViewHolder(holder: AdViewHolder, position: Int) {
        holder.adItem.text = list?.get(position)?.displayText
    }

    /**
     * Holder class having the text for the ad types
     */
    class AdViewHolder(view: View, private val itemClickListener: OnItemClickListener): RecyclerView.ViewHolder(view){
