...
public class VideoInterstitialActivity extends AppCompatActivity {
    ...
    private static final String OPENWRAP_AD_UNIT_ONE = "OtherASInterstitialAdUnit";
    private static final String PUB_ID = "156276";
    private static final int PROFILE_ID = 1757;
    private static final String DUMMY_AD_SERVER_AD_UNIT_ID = "OtherASInterstitialAdUnit";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomInterstitialEventHandler eventHandler = new CustomInterstitialEventHandler(this, DUMMY_AD_SERVER_AD_UNIT_ID);
